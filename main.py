...
client.loop_start()  # Run the MQTT client loop in a non-blocking way
...
while True:
    ...
    if hands:
        ...
        if center_y <= gesture_threshold:  # If hand is within bounds
        ...
        client.publish("python/buzzer", "1", qos=1)  # Hand is not detected, consider it out of bounds
        annotation_started = False
